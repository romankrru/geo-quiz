...
- Component props: export the props object type as `Props`; implement as `function Foo(props: Props)` and read fields as `props.*`—no parameter destructuring in the signature.
